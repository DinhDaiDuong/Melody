...
class _ModifyAlbumState extends State<ModifyAlbum> {
  final GlobalKey<FormState> _modifyAlbumKey = GlobalKey<FormState>();
                      ...
                      try {
                        ...
                        if (user != null) {
                          try {
                            ...
                            Album album;
                            var docAlbum = FirebaseFirestore.instance
                                .collection('Albums')
                                .doc();
                            if (widget.album != null) {
                              docAlbum = FirebaseFirestore.instance
                                  .collection('Albums')
                                  .doc(widget.album!.id);
                            }
