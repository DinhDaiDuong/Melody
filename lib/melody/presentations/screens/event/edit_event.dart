...
class EditEventSrceen extends StatefulWidget {
  final String id;
  const EditEventSrceen({super.key, required this.id});
                      ...
                      CustomButton(
                        onClick: () async {
                          try {
                            ...
                            String inputStartDate = "${startDateController.text} at ${startTimeController.text} PM UTC+7";
                            DateTime parsedStartDate =
                                inputFormat.parse(inputStartDate);

                            String inputEndDate = "${endDateController.text} at ${endTimeController.text} PM UTC+7";
